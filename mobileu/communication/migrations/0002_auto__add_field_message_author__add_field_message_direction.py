...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'communication_message', 'author',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.CustomUser'], null=True, blank=True),
                      keep_default=False)

        # Adding field 'Message.direction'
        db.add_column(u'communication_message', 'direction',
    ...
    def backwards(self, orm):
        ...
        db.delete_column(u'communication_message', 'author_id')

        # Deleting field 'Message.direction'
        db.delete_column(u'communication_message', 'direction')
