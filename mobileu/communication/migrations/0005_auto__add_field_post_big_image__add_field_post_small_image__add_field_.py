...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Post.big_image'
        db.add_column(u'communication_post', 'big_image',
                      self.gf('django.db.models.fields.files.ImageField')(max_length=100, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Post.small_image'
        db.add_column(u'communication_post', 'small_image',
                      self.gf('django.db.models.fields.files.ImageField')(max_length=100, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Post.moderated'
        db.add_column(u'communication_post', 'moderated',
                      self.gf('django.db.models.fields.NullBooleanField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Post.big_image'
        db.delete_column(u'communication_post', 'big_image')

        # Deleting field 'Post.small_image'
        db.delete_column(u'communication_post', 'small_image')

        # Deleting field 'Post.moderated'
        db.delete_column(u'communication_post', 'moderated')
