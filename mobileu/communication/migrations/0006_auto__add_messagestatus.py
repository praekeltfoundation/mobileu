...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'communication_messagestatus', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('message', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['communication.Message'], null=True)),
            ('view_status', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('view_date', self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True)),
            ('hidden_status', self.gf('django.db.models.fields.BooleanField')(default=False)),
        ...
        db.send_create_signal(u'communication', ['MessageStatus'])


    def backwards(self, orm):
        # Deleting model 'MessageStatus'
        db.delete_table(u'communication_messagestatus')
