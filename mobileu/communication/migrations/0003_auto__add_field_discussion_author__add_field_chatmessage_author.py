...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Discussion.author'
        db.add_column(u'communication_discussion', 'author',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.CustomUser'], null=True, blank=True),
                      keep_default=False)

        # Adding field 'ChatMessage.author'
        db.add_column(u'communication_chatmessage', 'author',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.CustomUser'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Discussion.author'
        db.delete_column(u'communication_discussion', 'author_id')

        # Deleting field 'ChatMessage.author'
        db.delete_column(u'communication_chatmessage', 'author_id')
