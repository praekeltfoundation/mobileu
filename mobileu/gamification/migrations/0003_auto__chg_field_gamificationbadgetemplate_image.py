...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'GamificationBadgeTemplate.image'
        db.alter_column(u'gamification_gamificationbadgetemplate', 'image', self.gf('django.db.models.fields.files.ImageField')(max_length=100, null=True))

    def backwards(self, orm):

        # Changing field 'GamificationBadgeTemplate.image'
        db.alter_column(u'gamification_gamificationbadgetemplate', 'image', self.gf('django.db.models.fields.URLField')(max_length=200, null=True))
