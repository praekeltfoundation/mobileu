...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'GamificationBadgeTemplate.backup'
        db.add_column(u'gamification_gamificationbadgetemplate', 'backup',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=50, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'GamificationBadgeTemplate.backup'
        db.delete_column(u'gamification_gamificationbadgetemplate', 'backup')


    models = {
        u'gamification.gamificationbadgetemplate': {
            'Meta': {'object_name': 'GamificationBadgeTemplate'},
            'backup': ('django.db.models.fields.CharField', [], {'max_length': '50', 'blank': 'True'}),
