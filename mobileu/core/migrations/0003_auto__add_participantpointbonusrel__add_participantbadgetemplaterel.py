...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'ParticipantPointBonusRel'
        db.create_table(u'core_participantpointbonusrel', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('participant', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['core.Participant'])),
            ('pointbonus', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['gamification.GamificationPointBonus'])),
            ('scenario', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['gamification.GamificationScenario'])),
            ('awarddate', self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True)),
        ))
        db.send_create_signal(u'core', ['ParticipantPointBonusRel'])

        # Adding model 'ParticipantBadgeTemplateRel'
        db.create_table(u'core_participantbadgetemplaterel', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('participant', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['core.Participant'])),
            ('badgetemplate', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['gamification.GamificationBadgeTemplate'])),
            ('scenario', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['gamification.GamificationScenario'])),
            ('awarddate', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2014, 5, 15, 0, 0), null=True)),
        ))
        db.send_create_signal(u'core', ['ParticipantBadgeTemplateRel'])
    ...
    def backwards(self, orm):
        # Deleting model 'ParticipantPointBonusRel'
        db.delete_table(u'core_participantpointbonusrel')

        # Deleting model 'ParticipantBadgeTemplateRel'
        db.delete_table(u'core_participantbadgetemplaterel')
    ...
    models = {
        ...
        u'core.participantbadgetemplaterel': {
            ...
            'awarddate': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 5, 15, 0, 0)', 'null': 'True'}),
        ...
        u'core.participantquestionanswer': {
            ...
            'answerdate': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2014, 5, 15, 0, 0)', 'null': 'True'}),
            'correct': ('django.db.models.fields.BooleanField', [], {}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
