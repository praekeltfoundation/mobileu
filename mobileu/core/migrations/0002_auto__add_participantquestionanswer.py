...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'ParticipantQuestionAnswer'
        db.create_table(u'core_participantquestionanswer', (
            ...
            ('answerdate', self.gf('django.db.models.fields.DateField')(null=True, blank=True)),
        ))
        db.send_create_signal(u'core', ['ParticipantQuestionAnswer'])


    def backwards(self, orm):
        # Deleting model 'ParticipantQuestionAnswer'
        db.delete_table(u'core_participantquestionanswer')
    ...
    models = {
        ...
        u'core.participantquestionanswer': {
            ...
            'answerdate': ('django.db.models.fields.DateField', [], {'null': 'True', 'blank': 'True'}),
            'correct': ('django.db.models.fields.BooleanField', [], {}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
