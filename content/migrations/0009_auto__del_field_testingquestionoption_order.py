...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'TestingQuestionOption.order'
        db.delete_column(u'content_testingquestionoption', 'order')


    def backwards(self, orm):
        # Adding field 'TestingQuestionOption.order'
        db.add_column(u'content_testingquestionoption', 'order',
